...
class CryptoServiceTest {
    ...
    @Test
    void shouldEncryptUserNameAndEmail_whenUserExistsAndPublicKeyIsValid() {
    ...
    @Test
    void shouldDecryptUserNameAndEmail_whenUserExistsAndPrivateKeyIsValid() {
        var userMock = User.builder()
    ...
    @Test
    void shouldThrowApplicationException_whenTryingToEncryptAnEncryptedInformation() {
        var userMock = User.builder()
                .name(RSAUtil.encrypt("rodrick", PUBLIC_KEY))
                .email(RSAUtil.encrypt("rodrik@email.com", PUBLIC_KEY))
                .build();
    ...
    @Test
    void shouldThrowApplicationException_whenTryingToDecryptAnDecryptedInformation() {
        var userMock = User.builder()
                .name("rodrick")
                .email("rodrik@email.com")
                .build();
